...
- Placeholder→real-user migration (#6): still open — the claim flow (open share link → "this is me" → User twin created, `hasCrew` edges transferred) is the designed mechanism; User twin creation + edge transfer not yet implemented.
